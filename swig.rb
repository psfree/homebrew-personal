class Swig < Formula
  ...
  def install
    ...
    inreplace "CCache/Makefile.in", "-yodl2man -o $(srcdir)/$(PACKAGE_NAME).1 $(srcdir)/ccache.yo", "-yodl2man $(srcdir)/ccache.yo && mv $(srcdir)/ccache.man $(srcdir)/$(PACKAGE_NAME).1" if build.head?
